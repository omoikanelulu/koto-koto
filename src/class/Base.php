    ...
    public function __construct()
    {
        ...
        $this->nav_menus = array(
            'links' => array(
                ...
                "デキゴトを修正" => 'http://' . $_SERVER["HTTP_HOST"] . '/koto-koto/src/html/things/edit/thing_edit.php',
                "対処法を記録" => 'http://' . $_SERVER["HTTP_HOST"] . '/koto-koto/src/html/things/edit/input_bad_thing_approach.php',
                "- - - - - - - - - - - - - -" => '',
            ...
            'not_links' => array(
                ...
                "編集内容確認" => 'http://' . $_SERVER["HTTP_HOST"] . '/koto-koto/src/html/user/edit/confirm.php',
