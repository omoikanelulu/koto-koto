            ...
            <form action="./action.php" method="post">
                ...
                <div class="row mt-4 justify-content-start">
                    ...
                    <div class="col-sm-auto align-self-center">
                        <input onclick="return false" class="form-check-input" type="checkbox" name="good_thing_flag" id="good_thing_flag" <?= $thing['good_thing_flag'] == '1' ? 'checked' : '' ?>>
                        ...
                        <div class="input-group">
                            ...
                            <select disabled class="level form-select" name="good_thing_rank" id="good_thing_rank">
                                <?php foreach (Config::GOOD_THING_RANK as $i) : ?>
                                    <option><?= isset($thing['good_thing_rank']) ? $thing['good_thing_rank'] : '' ?>位</option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <!-- ヤナコトブロック -->
                    <div class="col-sm-auto align-self-center">
                        <input onclick="return false" class="form-check-input" type="checkbox" name="bad_thing_flag" id="bad_thing_flag" <?= $thing['bad_thing_flag'] == '1' ? 'checked' : '' ?>>
                    ...
                    <div class="col-sm-auto align-self-center">
                        <div class="input-group">
                            ...
                            <select disabled class="level form-select" name="bad_thing_level" id="bad_thing_level">
                                <?php switch ($thing['bad_thing_level']) {
                                    case 1:
                                        echo '弱';
                                        break;
                                    case 2:
